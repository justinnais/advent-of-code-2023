...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `78.0µs` | `834.8µs` |
| [Day 2](./src/bin/02.rs) | `108.3µs` | `104.1µs` |
| [Day 3](./src/bin/03.rs) | `460.7µs` | `245.0µs` |
| [Day 4](./src/bin/04.rs) | `158.3µs` | `1.2ms` |
| [Day 6](./src/bin/06.rs) | `313.0ns` | `8.2ms` |
